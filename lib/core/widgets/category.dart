...
//           // ✅ FIX — shimmer skeleton instead of spinner
//           if (snapshot.connectionState == ConnectionState.waiting) {
//             return ShimmerLoader(type: ShimmerLayoutType.category);
//           }
          ...
          return BlocBuilder<FoodCategoryFilterCubit, String?>(
            builder: (context, selectedCategory) {
              return ListView.separated(
                scrollDirection: Axis.horizontal,
                itemCount: categories.length,
                // ✅ FIX — fixed gap between every item, no name-length effect
...
class CategoryItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      // ✅ FIX — fixed width so every item takes same space regardless of name
      width: 75,
      child: Column(
        children: [
          InkWell(
